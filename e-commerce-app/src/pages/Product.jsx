...
function Product({ product }) {
  ...
  return (
    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2">
      <a className="flex items-center justify-center bg-white " href="#">
        <img className="p-8 w-48 h-40 object-contain object-center rounded-t-lg" src={image} alt="product image" />
      </a>
